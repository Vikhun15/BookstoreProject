...
document.getElementById("themeImg").addEventListener("click", function () {
    if (document.getElementById("themeImg").classList.contains("day")) {
        document
            ...
            .setAttribute("src", "/images/icons/moon.png");
        ...
        document.getElementById("bg-image").style.backgroundColor =
            "rgba(0,0,0,0.8)";
        ...
        if (document.getElementsByClassName("webshop-table").length > 0) {
            ...
            )[0].style.backgroundColor = "#653719";
        ...
        if (document.getElementsByClassName("review").length > 0) {
            ...
            for (var item of document.getElementsByClassName("review-header")) {
                item.style.borderColor = "white";
            }
        }
        setCookie("night");
        ...
        document
            .getElementById("themeImg")
            .setAttribute("src", "/images/icons/sun.png");
